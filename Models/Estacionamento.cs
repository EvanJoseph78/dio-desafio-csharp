namespace DesafioFundamentos.Models
{
    public class Estacionamento
    {
        ...
        {
            // TODO: Pedir para o usuário digitar uma placa (ReadLine) e adicionar na
            // lista "veiculos" *IMPLEMENTE AQUI*
        ...
        public void RemoverVeiculo()
        {
            ...
            if (veiculos.Any(x => x.ToUpper() == placa.ToUpper()))
            {
                ...
                // TODO: Realizar o seguinte cálculo: "precoInicial + precoPorHora *
                // horas" para a variável valorTotal *IMPLEMENTE AQUI*
                int horas = 0;
